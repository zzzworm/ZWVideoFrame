...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "Pods-ZWVideoFrame/Advance.framework"
  install_framework "Pods-ZWVideoFrame/EasyTipView.framework"
  install_framework "Pods-ZWVideoFrame/FDTake.framework"
  install_framework "Pods-ZWVideoFrame/OMGHTTPURLRQ.framework"
  install_framework "Pods-ZWVideoFrame/PKHUD.framework"
  install_framework "Pods-ZWVideoFrame/PageMenu.framework"
  install_framework "Pods-ZWVideoFrame/Player.framework"
  install_framework "Pods-ZWVideoFrame/PromiseKit.framework"
  ...
  install_framework "Pods-ZWVideoFrame/SCRecorder.framework"
